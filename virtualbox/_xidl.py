...
class DHCPServer(Interface):
    ...
    def set_configuration(
        ...
        """
        self._call_method(
            "setConfiguration", ip_address, network_mask, from_ip_address, to_ip_address
        )
...
class VirtualBox(Interface):
    ...
    def compose_machine_filename(self, name, group, create_flags, base_folder):
        ...
        ret = str(
            self._call_method(
                "composeMachineFilename", name, group, create_flags, base_folder
            )
        )
        return ret
    ...
    def create_machine(self, settings_file, name, groups, os_type_id, flags):
        ...
        ret = Machine(
            self._call_method(
                "createMachine", settings_file, name, groups, os_type_id, flags
            )
        )
        return ret
    ...
    def create_medium(self, format_, location, access_mode, a_device_type_type):
        ...
        ret = Medium(
            self._call_method(
                "createMedium", format_, location, access_mode, a_device_type_type
            )
        )
        return ret
    ...
    def open_medium(self, location, device_type, access_mode, force_new_uuid):
        ...
        ret = Medium(
            self._call_method(
                "openMedium", location, device_type, access_mode, force_new_uuid
            )
        )
        return ret
    ...
    def check_firmware_present(self, firmware_type, version):
        ...
        """
        result, url, file_ = self._call_method(
            "checkFirmwarePresent", firmware_type, version
        )
...
class Appliance(Interface):
    ...
    def virtual_system_descriptions(self):
      ...
      This array is empty until either
        ...
        """
        return [
            VirtualSystemDescription(obj)
            for obj in self._get_property("virtualSystemDescriptions")
        ]
...
class VirtualSystemDescription(Interface):
    ...
    def get_description(self):
        ...
        """
        types, refs, ovf_values, virtualbox_values, extra_config_values = self._call_method(
            "getDescription"
        )
    ...
    def set_final_values(self, enabled, virtualbox_values, extra_config_values):
        ...
        """
        self._call_method(
            "setFinalValues", enabled, virtualbox_values, extra_config_values
        )
...
class Machine(Interface):
    ...
    def get_boot_order(self, position):
        ...
        """
        ret = DeviceType(self._call_method("getBootOrder", position))
        return ret
    ...
    def attach_device_without_medium(self, name, controller_port, device, type_):
      ...
      be 0.
        ...
        """
        self._call_method(
            "attachDeviceWithoutMedium", name, controller_port, device, type_
        )
    ...
    def passthrough_device(self, name, controller_port, device, passthrough):
        ...
        """
        self._call_method(
            "passthroughDevice", name, controller_port, device, passthrough
        )
    ...
    def temporary_eject_device(self, name, controller_port, device, temporary_eject):
        ...
        """
        self._call_method(
            "temporaryEjectDevice", name, controller_port, device, temporary_eject
        )
    ...
    def non_rotational_device(self, name, controller_port, device, non_rotational):
        ...
        """
        self._call_method(
            "nonRotationalDevice", name, controller_port, device, non_rotational
        )
    ...
    def set_auto_discard_for_device(self, name, controller_port, device, discard):
        ...
        """
        self._call_method(
            "setAutoDiscardForDevice", name, controller_port, device, discard
        )
    ...
    def set_hot_pluggable_for_device(
        ...
        """
        self._call_method(
            "setHotPluggableForDevice", name, controller_port, device, hot_pluggable
        )
    ...
    def set_bandwidth_group_for_device(
        ...
        """
        self._call_method(
            "setBandwidthGroupForDevice", name, controller_port, device, bandwidth_group
        )
    ...
    def get_medium(self, name, controller_port, device):
        ...
        """
        ret = Medium(self._call_method("getMedium", name, controller_port, device))
        return ret
    ...
    def get_medium_attachments_of_controller(self, name):
        ...
        """
        ret = MediumAttachment(
            self._call_method("getMediumAttachmentsOfController", name)
        )
        return ret
    ...
    def get_medium_attachment(self, name, controller_port, device):
        ...
        """
        ret = MediumAttachment(
            self._call_method("getMediumAttachment", name, controller_port, device)
        )
        return ret
    ...
    def attach_host_pci_device(
        ...
        """
        self._call_method(
            "attachHostPCIDevice", host_address, desired_guest_address, try_to_unbind
        )
    ...
    def add_storage_controller(self, name, connection_type):
        ...
        """
        ret = StorageController(
            self._call_method("addStorageController", name, connection_type)
        )
        return ret
    ...
    def get_storage_controller_by_instance(self, connection_type, instance):
        ...
        ret = StorageController(
            self._call_method(
                "getStorageControllerByInstance", connection_type, instance
            )
        )
        return ret
    ...
    def get_cpuid_leaf_by_ordinal(self, ordinal):
        ...
        """
        idx, idx_sub, val_eax, val_ebx, val_ecx, val_edx = self._call_method(
            "getCPUIDLeafByOrdinal", ordinal
        )
    ...
    def get_cpuid_leaf(self, idx, idx_sub):
        ...
        """
        val_eax, val_ebx, val_ecx, val_edx = self._call_method(
            "getCPUIDLeaf", idx, idx_sub
        )
    ...
    def set_cpuid_leaf(self, idx, idx_sub, val_eax, val_ebx, val_ecx, val_edx):
        ...
        """
        self._call_method(
            "setCPUIDLeaf", idx, idx_sub, val_eax, val_ebx, val_ecx, val_edx
        )
    ...
    def export_to(self, appliance, location):
        ...
        """
        ret = VirtualSystemDescription(
            self._call_method("exportTo", appliance, location)
        )
        return ret
    ...
    def enumerate_guest_properties(self, patterns):
        ...
        :rtype: typing.List[typing.Tuple[str, str, int, str]]
        """
        names, values, timestamps, flags = self._call_method(
            "enumerateGuestProperties", patterns
        )
        return names, values, timestamps, flags
    ...
    def query_saved_guest_screen_info(self, screen_id):
        ...
        """
        origin_x, origin_y, width, height, enabled = self._call_method(
            "querySavedGuestScreenInfo", screen_id
        )
    ...
    def read_saved_thumbnail_to_array(self, screen_id, bitmap_format):
        ...
        """
        data, width, height = self._call_method(
            "readSavedThumbnailToArray", screen_id, bitmap_format
        )
    ...
    def query_saved_screenshot_info(self, screen_id):
        ...
        """
        bitmap_formats, width, height = self._call_method(
            "querySavedScreenshotInfo", screen_id
        )
    ...
    def read_saved_screenshot_to_array(self, screen_id, bitmap_format):
        ...
        """
        data, width, height = self._call_method(
            "readSavedScreenshotToArray", screen_id, bitmap_format
        )
        return data, width, height
    ...
    def medium_attachments(self):
        ...
        """
        return [
            MediumAttachment(obj) for obj in self._get_property("mediumAttachments")
        ]
    ...
    def storage_controllers(self):
        ...
        """
        return [
            StorageController(obj) for obj in self._get_property("storageControllers")
        ]
    ...
    def pci_device_assignments(self):
        ...
        """
        return [
            PCIDeviceAttachment(obj)
            for obj in self._get_property("PCIDeviceAssignments")
        ]
...
class Console(Interface):
    ...
    def teleport(self, hostname, tcpport, password, max_downtime):
        ...
        """
        ret = Progress(
            self._call_method("teleport", hostname, tcpport, password, max_downtime)
        )
        return ret
    ...
    def add_disk_encryption_passwords(self, ids, passwords, clear_on_suspend):
        ...
        """
        self._call_method(
            "addDiskEncryptionPasswords", ids, passwords, clear_on_suspend
        )
    ...
    def attached_pci_devices(self):
        ...
        """
        return [
            PCIDeviceAttachment(obj) for obj in self._get_property("attachedPCIDevices")
        ]
...
class HostNetworkInterface(Interface):
    ...
    def enable_static_ip_config_v6(self, ipv6_address, ipv6_network_mask_prefix_length):
        ...
        """
        self._call_method(
            "enableStaticIPConfigV6", ipv6_address, ipv6_network_mask_prefix_length
        )
...
class Host(Interface):
    ...
    def get_processor_cpuid_leaf(self, cpu_id, leaf, sub_leaf):
        ...
        """
        val_eax, val_ebx, val_ecx, val_edx = self._call_method(
            "getProcessorCPUIDLeaf", cpu_id, leaf, sub_leaf
        )
        return val_eax, val_ebx, val_ecx, val_edx
    ...
    def find_host_network_interface_by_name(self, name):
        ...
        """
        ret = HostNetworkInterface(
            self._call_method("findHostNetworkInterfaceByName", name)
        )
        return ret
    ...
    def find_host_network_interface_by_id(self, id_):
        ...
        """
        ret = HostNetworkInterface(
            self._call_method("findHostNetworkInterfaceById", id_)
        )
        return ret
    ...
    def find_host_network_interfaces_of_type(self, type_):
        ...
        """
        ret = HostNetworkInterface(
            self._call_method("findHostNetworkInterfacesOfType", type_)
        )
        return ret
    ...
    def add_usb_device_source(
        self, backend, id_, address, property_names, property_values
    ):
        """None
        :param str backend:
        ...
        """
        self._call_method(
            "addUSBDeviceSource", backend, id_, address, property_names, property_values
        )
    ...
    def usb_device_filters(self):
        ...
        """
        return [
            HostUSBDeviceFilter(obj) for obj in self._get_property("USBDeviceFilters")
        ]
    ...
    def network_interfaces(self):
        ...
        """
        return [
            HostNetworkInterface(obj) for obj in self._get_property("networkInterfaces")
        ]
    ...
    def video_input_devices(self):
        ...
        """
        return [
            HostVideoInputDevice(obj) for obj in self._get_property("videoInputDevices")
        ]
...
class SystemProperties(Interface):
    ...
    def get_default_io_cache_setting_for_storage_controller(self, controller_type):
        ...
        ret = bool(
            self._call_method(
                "getDefaultIoCacheSettingForStorageController", controller_type
            )
        )
        return ret
    ...
    def get_storage_controller_hotplug_capable(self, controller_type):
        ...
        """
        ret = bool(
            self._call_method("getStorageControllerHotplugCapable", controller_type)
        )
        return ret
    ...
    def get_max_instances_of_usb_controller_type(self, chipset, type_):
        ...
        """
        ret = int(
            self._call_method("getMaxInstancesOfUSBControllerType", chipset, type_)
        )
        return ret
...
class GuestOSType(Interface):
    ...
    def recommended_dvd_storage_controller(self):
        ...
        return StorageControllerType(
            self._get_property("recommendedDVDStorageController")
        )
    ...
    def recommended_hd_storage_controller(self):
        ...
        """
        return StorageControllerType(
            self._get_property("recommendedHDStorageController")
        )
...
class DnDSource(DnDBase):
    ...
    def drag_is_pending(self, screen_id):
        ...
        """
        default_action, formats, allowed_actions = self._call_method(
            "dragIsPending", screen_id
        )
...
class DnDTarget(DnDBase):
    ...
    def enter(self, screen_id, y, x, default_action, allowed_actions, formats):
        ...
        ret = DnDAction(
            self._call_method(
                "enter", screen_id, y, x, default_action, allowed_actions, formats
            )
        )
        return ret
    ...
    def move(self, screen_id, x, y, default_action, allowed_actions, formats):
        ...
        ret = DnDAction(
            self._call_method(
                "move", screen_id, x, y, default_action, allowed_actions, formats
            )
        )
        return ret
    ...
    def drop(self, screen_id, x, y, default_action, allowed_actions, formats):
        ...
        """
        result_action, format_ = self._call_method(
            "drop", screen_id, x, y, default_action, allowed_actions, formats
        )
...
class GuestSession(Interface):
    ...
    def directory_copy_from_guest(self, source, destination, flags):
        ...
        """
        ret = Progress(
            self._call_method("directoryCopyFromGuest", source, destination, flags)
        )
        return ret
    ...
    def directory_copy_to_guest(self, source, destination, flags):
        ...
        """
        ret = Progress(
            self._call_method("directoryCopyToGuest", source, destination, flags)
        )
        return ret
    ...
    def directory_create_temp(self, template_name, mode, path, secure):
        ...
        """
        ret = str(
            self._call_method("directoryCreateTemp", template_name, mode, path, secure)
        )
        return ret
    ...
    def file_copy_from_guest(self, source, destination, flags):
        ...
        """
        ret = Progress(
            self._call_method("fileCopyFromGuest", source, destination, flags)
        )
        return ret
    ...
    def file_create_temp(self, template_name, mode, path, secure):
        ...
        """
        ret = GuestFile(
            self._call_method("fileCreateTemp", template_name, mode, path, secure)
        )
        return ret
    ...
    def file_open(self, path, access_mode, open_action, creation_mode):
        ...
        """
        ret = GuestFile(
            self._call_method("fileOpen", path, access_mode, open_action, creation_mode)
        )
        return ret
    ...
    def wait_for_array(self, wait_for, timeout_ms):
        ...
        :returns:
          ...
          see
        """
        ret = GuestSessionWaitResult(
            self._call_method("waitForArray", wait_for, timeout_ms)
        )
        return ret
...
class Guest(Interface):
    ...
    def internal_get_statistics(self):
        ...
        """
        cpu_user, cpu_kernel, cpu_idle, mem_total, mem_free, mem_balloon, mem_shared, mem_cache, paged_total, mem_alloc_total, mem_free_total, mem_balloon_total, mem_shared_total = self._call_method(
    ...
    def set_credentials(self, user_name, password, domain, allow_interactive_logon):
        ...
        """
        self._call_method(
            "setCredentials", user_name, password, domain, allow_interactive_logon
        )
    ...
    def create_session(self, user, password, domain, session_name):
        ...
        """
        ret = GuestSession(
            self._call_method("createSession", user, password, domain, session_name)
        )
        return ret
    ...
    def update_guest_additions(self, source, arguments, flags):
        ...
        """
        ret = Progress(
            self._call_method("updateGuestAdditions", source, arguments, flags)
        )
        return ret
...
class Progress(Interface):
    ...
    def set_next_operation(self, next_operation_description, next_operations_weight):
        ...
        """
        self._call_method(
            "setNextOperation", next_operation_description, next_operations_weight
        )
...
class MediumFormat(Interface):
    ...
    def describe_properties(self):
        ...
        """
        names, descriptions, types, flags, defaults = self._call_method(
            "describeProperties"
        )
    ...
    def capabilities(self):
        ...
        """
        return [
            MediumFormatCapabilities(obj) for obj in self._get_property("capabilities")
        ]
...
class DisplaySourceBitmap(Interface):
    ...
    def query_bitmap_info(self):
        ...
        """
        address, width, height, bits_per_pixel, bytes_per_line, bitmap_format = self._call_method(
            "queryBitmapInfo"
        )
...
class Framebuffer(Interface):
    ...
    def capabilities(self):
        ...
        """
        return [
            FramebufferCapabilities(obj) for obj in self._get_property("capabilities")
        ]
...
class Display(Interface):
    ...
    def get_screen_resolution(self, screen_id):
        ...
        """
        width, height, bits_per_pixel, x_origin, y_origin, guest_monitor_status = self._call_method(
            "getScreenResolution", screen_id
        )
    ...
    def take_screen_shot(self, screen_id, address, width, height, bitmap_format):
        ...
        """
        self._call_method(
            "takeScreenShot", screen_id, address, width, height, bitmap_format
        )
    ...
    def take_screen_shot_to_array(self, screen_id, width, height, bitmap_format):
        ...
        ret = bytes(
            self._call_method(
                "takeScreenShotToArray", screen_id, width, height, bitmap_format
            )
        )
        return ret
...
class InternalSessionControl(Interface):
    ...
    def on_usb_device_attach(self, device, error, masked_interfaces, capture_filename):
        ...
        """
        self._call_method(
            "onUSBDeviceAttach", device, error, masked_interfaces, capture_filename
        )
    ...
    def access_guest_property(self, name, value, flags, access_mode):
        ...
        :rtype: typing.Tuple[str, int, str]
        """
        ret_value, ret_timestamp, ret_flags = self._call_method(
            "accessGuestProperty", name, value, flags, access_mode
        )
    ...
    def enumerate_guest_properties(self, patterns):
        ...
        :rtype: typing.List[typing.Tuple[str, str, int, str]]
        """
        keys, values, timestamps, flags = self._call_method(
            "enumerateGuestProperties", patterns
        )
    ...
    def online_merge_medium(self, medium_attachment, source_idx, target_idx, progress):
        ...
        """
        self._call_method(
            "onlineMergeMedium", medium_attachment, source_idx, target_idx, progress
        )
...
class PerformanceCollector(Interface):
    ...
    def setup_metrics(self, metric_names, objects, period, count):
        ...
        """
        ret = PerformanceMetric(
            self._call_method("setupMetrics", metric_names, objects, period, count)
        )
        return ret
    ...
    def enable_metrics(self, metric_names, objects):
        ...
        """
        ret = PerformanceMetric(
            self._call_method("enableMetrics", metric_names, objects)
        )
        return ret
    ...
    def disable_metrics(self, metric_names, objects):
        ...
        """
        ret = PerformanceMetric(
            self._call_method("disableMetrics", metric_names, objects)
        )
        return ret
    ...
    def query_metrics_data(self, metric_names, objects):
        ...
        """
        return_data, return_metric_names, return_objects, return_units, return_scales, return_sequence_numbers, return_data_indices, return_data_lengths = self._call_method(
            "queryMetricsData", metric_names, objects
        )
...
class NATEngine(Interface):
    ...
    def set_network_settings(self, mtu, sock_snd, sock_rcv, tcp_wnd_snd, tcp_wnd_rcv):
        ...
        """
        self._call_method(
            "setNetworkSettings", mtu, sock_snd, sock_rcv, tcp_wnd_snd, tcp_wnd_rcv
        )
    ...
    def get_network_settings(self):
        ...
        """
        mtu, sock_snd, sock_rcv, tcp_wnd_snd, tcp_wnd_rcv = self._call_method(
            "getNetworkSettings"
        )
    ...
    def add_redirect(self, name, proto, host_ip, host_port, guest_ip, guest_port):
        ...
        """
        self._call_method(
            "addRedirect", name, proto, host_ip, host_port, guest_ip, guest_port
        )
...
class ExtPackBase(Interface):
    ...
    def query_license(self, preferred_locale, preferred_language, format_):
        ...
        ret = str(
            self._call_method(
                "queryLicense", preferred_locale, preferred_language, format_
            )
        )
        return ret
...
class ExtPackManager(Interface):
    ...
    def uninstall(self, name, forced_removal, display_info):
        ...
        """
        ret = Progress(
            self._call_method("uninstall", name, forced_removal, display_info)
        )
        return ret
